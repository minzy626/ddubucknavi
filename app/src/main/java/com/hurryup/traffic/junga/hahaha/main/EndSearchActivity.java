...
public class EndSearchActivity  extends AppCompatActivity implements MapView.MapViewEventListener, MapView.POIItemEventListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_end_search);
        ...
        Search =(AutoCompleteTextView)findViewById(R.id.tv_search);
        Search.setText(end);
    ...
    class CustomCalloutBalloonAdapter implements CalloutBalloonAdapter {
        ...
        public CustomCalloutBalloonAdapter() {
            mCalloutBalloon = getLayoutInflater().inflate(R.layout.custom_call_balloon, null);
        }
